...
Taken from https://github.com/PX4/PX4-Autopilot/blob/main/Tools/mavlink_shell.py
...
class MavlinkSerialPort:
    ...
    def __init__(self, portname, baudrate, devnum=0, debug=0):
        ...
        self.mav = mavutil.mavlink_connection(
            portname, autoreconnect=True, baud=baudrate
        )
...
/dev/ttyUSB0 or 0.0.0.0:14550. Auto-detect serial if not given.",
    ...
    parser.add_argument(
        ...
        dest="baudrate",
        type=int,
        help="Mavlink port baud rate (default=57600)",
        default=57600,
    )
